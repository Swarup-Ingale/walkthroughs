...
# Method of Solve
- The Part 01 of this challenge can be solves using the following code:
- The Python version is :
```
target = int(open("input_14").read().strip())
...
const target = Number(
    fs.readFileSync('input_14', 'utf8').trim()
);

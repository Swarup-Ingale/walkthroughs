...
For example :
```
for the strings above, the total encoded length (6 + 9 + 16 + 11 = 42) minus the characters in the original code representation (23, just like in the first part of this puzzle) is 42 - 23 = 19.
```
  ...
  ```
    ...
    with open("input_08_01") as f:
        for line in f:
            ...
            encoded_len = 2  		# new surrounding quotes
            for c in line:
                if c in ['"', '\\']:
                    encoded_len += 2
                else:
    ...
    print(encoded_total - original_total)
  ```

# This Concludes the Day 08 of Advent of Code Challenge.
